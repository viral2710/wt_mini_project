  ...
  <main>
        <div class="row">
            <div class="container"><?php
                ...
                $sql = "SELECT * FROM product where sname='$name' and time>='$time'";
                        ...
                        echo "<div class='col-md-4'>
                                <div class='product-container'>
                                    <div class='product-image'>
                                        ...
                                        <a href='http://localhost/wt_mini_project/sellerppage.php?data=".$name."&pid=".$row[7]."' class='product-link'>more</a>
