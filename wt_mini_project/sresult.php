  ...
  <div class="row">
      ...
      <div class="container">
        <?php
                ...
                $sql = "SELECT r.`id`, r.`bname`, r.`pid`, r.`Amount`,p.`name`,p.`sname`,p.`time` FROM `result` as r , `product` as p WHERE sname='$name' and p.pid=r.pid";
                ...
                <thead>
                    ...
                    while ($row = mysqli_fetch_row($result)) { 
                        ...
                        if($time<$today){
                            ...
                            <th>".$row[4]."</th>
                            <th>".$row[3]."</th>
                            <th><a  style='color: Blue;' href='http://localhost/wt_mini_project/sellerppage.php?data=".$name."&pid=".$row[2]."' class='product-link'>Link</a></th>
                        </tr>";
                        }
